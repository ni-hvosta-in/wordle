...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(UserIndexOutOfBoundsException.class)
    public ResponseEntity<ErrorResponse> handleUserIndexOutOfBoundsException(UserIndexOutOfBoundsException e) {
